  ...
  return (
    <header className="py-20 text-center bg-gray-900 text-white shadow-xl">
      <div className="container mx-auto px-4">
        ...
        <h2 className="text-3xl font-light text-yale-400 mb-6">
          {GREETING.tagline}
        </h2>
        ...
        <div className="mt-8">
          <a href="#contact" className="bg-yale-600 hover:bg-yale-700 text-white font-bold py-3 px-8 rounded-lg transition duration-300">
